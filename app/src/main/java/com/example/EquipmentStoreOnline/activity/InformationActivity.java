...
//        mapFragment.getMapAsync(this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng VietKytsk = new LatLng(62.019902, 129.707736);
        mMap.addMarker(new MarkerOptions().position(VietKytsk).title("Магазин VietKytsk").snippet("у. Кулаковского 42/2, г. Якутск, Республика Саха (Якутия)").icon(BitmapDescriptorFactory.defaultMarker()));
        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition = new CameraPosition.Builder().target(VietKytsk).zoom(90).build();
